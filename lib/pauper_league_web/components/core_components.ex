defmodule PauperLeagueWeb.CoreComponents do
  @moduledoc """
  ...
  def live_select_creation(%{field: %Phoenix.HTML.FormField{} = field} = assigns) do
    assigns =
      assigns
      |> assign(:errors, Enum.map(field.errors, &translate_error(&1)))
      |> assign(:live_select_opts, assigns_to_attributes(assigns, [:errors, :label]))
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PauperLeagueWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PauperLeagueWeb.Gettext, "errors", msg, opts)
    end
  end
